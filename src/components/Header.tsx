      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Link
              to="/"
              className="text-2xl font-bold bg-gaming-gradient bg-clip-text text-transparent px-[12px] hover:opacity-80 transition-opacity"
            >
              GHALY HAX
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-12">
            <a
              href="#home"
              className="text-gray-300 hover:text-purple-400 font-medium transition-colors px-[24px]"
            >
              الرئيسية
            </a>
            <a
