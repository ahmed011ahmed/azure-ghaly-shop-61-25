      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map(item => item.href === '/services' ? <Link key={item.name} to={item.href} className="text-gray-300 hover:text-purple-400 transition-colors font-medium">
                  {item.name}
        ...
        {isMenuOpen && <div className="md:hidden py-4 border-t border-purple-800/30">
            <nav className="flex flex-col space-y-4">
              {navItems.map(item => item.href === '/services' ? <Link key={item.name} to={item.href} className="text-gray-300 hover:text-purple-400 transition-colors font-medium px-4 py-2" onClick={() => setIsMenuOpen(false)}>
                    {item.name}
