          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="مثال: 🎯 Bypass GHALY + HAK RNG"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className={`mt-1 w-full px-3 py-2 bg-gray-800/50 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none ${
